...
public class SearchGenerator {
	...
	public boolean addSearchSource(MessageSource searchSource) {
		return messageSources.add(searchSource);
	}
	public boolean removeSearchSource(MessageSource searchSource) {
		return messageSources.remove(searchSource);
	}
