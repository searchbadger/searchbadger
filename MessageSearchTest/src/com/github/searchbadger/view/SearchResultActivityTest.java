...
public class SearchResultActivityTest extends
	...
	public void doMessageTest() {
		...
		SearchResultListFragment listFragment = (SearchResultListFragment)
	...
	public void testWithMessagesLandscape() {
		...
		testActivity = (SearchResultActivity) instrumentation.waitForMonitor(monitor);
		instrumentation.removeMonitor(monitor);
		assertNotNull(testActivity);

		// do some test
		SearchResultListFragment listFragment = (SearchResultListFragment) testActivity
